...
public class Snacks {
	...
	public Snacks(int item_id, String item_name, int item_price, String item_mfd, String item_doe) {
		super();
	...
	public String toString() {
		return "Snacks [item_id=" + item_id + ", item_name=" + item_name + ", item_price=" + item_price
